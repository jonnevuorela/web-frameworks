...
namespace API.Repositories
{
    ...
    */
    ...
    public class UsersSQLiteRepository : IUsersRepository
    {
        ...
        private async Task<AppUser?> Update(string firstname, string lastname, string username, long? id)
        {
        ...
        public async Task<AppUser?> Save(string firstname, string lastname, string username, long? id = null)
        {
            AppUser? user;
            if (id == null)
            {
